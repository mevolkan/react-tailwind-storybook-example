...
const Footer = () => {
  ...
  return (
    <footer class="text-center lg:text-left bg-white ">
      <div class="flex justify-center items-center lg:justify-between p-6 border-b border-gray-300 max-w-7xl mx-auto">
      ...
      <div class="mx-6 py-10 text-center md:text-left">
        <div class="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto">
          <div class="">
            <h6 class="
            uppercase
            font-semibold
          ...
          <div class="">
            <h6 class="uppercase font-semibold mb-4 flex justify-center md:justify-start text-indigo-600 hover:text-indigo-500">
              Products
            </h6>
            <p class="mb-4">
      ...
      <div class="text-center p-6 bg-gray-200">
        ...
        <a class="text-indigo-600 hover:text-indigo-500 font-semibold" href="https://tailwind-elements.com/">Tailwind Elements</a>
      </div>
    </footer>
  )
}
